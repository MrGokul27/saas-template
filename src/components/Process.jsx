export default function Process() {
  return (
    <section className="relative md:px-20 px-5 h-[100%] overflow-hidden">
      {/* RIGHT BACKGROUND CIRCLE */}
      <div className="absolute right-[-200px] top-[-50px] w-[500px] h-[500px] bg-[#E8ECFF] rounded-full opacity-50"></div>
      ...
      <div className="relative z-10">
        ...
        <div className="relative w-full max-w-6xl mx-auto mt-20 mb-20">
          ...
          <svg
            viewBox="0 0 900 300"
            fill="none"
            className="absolute -top-20 left-1/2 -translate-x-1/2 w-[150%] max-w-none rotate-[-30deg] opacity-60"
          >
            <path
            ...
            {[
              ...
              <div key={index} className={`absolute ${step.pos} w-[250px]`}>
                <div className="relative flex flex-col items-start">
                  ...
                  <p className="text-gray-500 w-[80%] text-sm mt-1">
                    {step.text}
                  </p>

                  <span className="absolute text-[150px] lg:text-[200px] font-bold text-gray-200 -z-10 -top-24 right-3">
                    {step.number}
                  </span>
                </div>
              </div>
